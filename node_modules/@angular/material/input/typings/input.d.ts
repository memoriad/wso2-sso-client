...
export declare class MatInput extends _MatInputMixinBase implements MatFormFieldControl<any>, OnChanges, OnDestroy, OnInit, DoCheck, CanUpdateErrorState {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatInput, "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", ["matInput"], { 'disabled': "disabled", 'id': "id", 'required': "required", 'type': "type", 'value': "value", 'readonly': "readonly", 'placeholder': "placeholder", 'errorStateMatcher': "errorStateMatcher" }, {}, never>;
}
export {};
