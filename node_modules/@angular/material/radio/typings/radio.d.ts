...
export declare class MatRadioGroup implements AfterContentInit, ControlValueAccessor {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatRadioGroup, "mat-radio-group", ["matRadioGroup"], { 'name': "name", 'labelPosition': "labelPosition", 'value': "value", 'selected': "selected", 'disabled': "disabled", 'required': "required", 'color': "color" }, { 'change': "change" }, ["_radios"]>;
}
/** @docs-private */
...
export declare class MatRadioButton extends _MatRadioButtonMixinBase implements OnInit, AfterViewInit, OnDestroy, CanDisableRipple, HasTabIndex {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<MatRadioButton, "mat-radio-button", ["matRadioButton"], { 'disableRipple': "disableRipple", 'tabIndex': "tabIndex", 'checked': "checked", 'value': "value", 'labelPosition': "labelPosition", 'disabled': "disabled", 'required': "required", 'color': "color", 'name': "name", 'id': "id", 'ariaLabel': "aria-label", 'ariaLabelledby': "aria-labelledby", 'ariaDescribedby': "aria-describedby" }, { 'change': "change" }, never>;
}
export {};
