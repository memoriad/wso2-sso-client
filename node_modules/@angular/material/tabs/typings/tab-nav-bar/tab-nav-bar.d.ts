...
export declare abstract class _MatTabNavBase extends MatPaginatedTabHeader implements AfterContentChecked, AfterContentInit, OnDestroy {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<_MatTabNavBase, "do-not-use-abstract-mat-tab-nav-base", never, { 'backgroundColor': "backgroundColor", 'disableRipple': "disableRipple", 'color': "color" }, {}, never>;
}
/**
...
export declare class MatTabNav extends _MatTabNavBase {
     ...
     */
    platform?: Platform, animationMode?: string);
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<MatTabNav, "[mat-tab-nav-bar]", ["matTabNavBar", "matTabNav"], { 'color': "color" }, {}, ["_items"]>;
}
...
export declare class _MatTabLinkBase extends _MatTabLinkMixinBase implements OnDestroy, CanDisable, CanDisableRipple, HasTabIndex, RippleTarget, FocusableOption {
    ...
    focus(): void;
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<_MatTabLinkBase, "do-not-use-abstract-mat-tab-link-base", never, { 'active': "active" }, {}, never>;
}
/**
...
export declare class MatTabLink extends _MatTabLinkBase implements OnDestroy {
    ...
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatTabLink, "[mat-tab-link], [matTabLink]", ["matTabLink"], { 'disabled': "disabled", 'disableRipple': "disableRipple", 'tabIndex': "tabIndex" }, {}, never>;
}
export {};
