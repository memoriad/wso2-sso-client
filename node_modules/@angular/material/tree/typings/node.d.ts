...
export declare class MatNestedTreeNode<T> extends CdkNestedTreeNode<T> implements AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatNestedTreeNode<any>, "mat-nested-tree-node", ["matNestedTreeNode"], { 'disabled': "disabled", 'tabIndex': "tabIndex", 'node': "matNestedTreeNode" }, {}, never>;
}
export {};
