...
export declare class MatButtonToggleGroup implements ControlValueAccessor, OnInit, AfterContentInit {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatButtonToggleGroup, "mat-button-toggle-group", ["matButtonToggleGroup"], { 'appearance': "appearance", 'name': "name", 'vertical': "vertical", 'value': "value", 'multiple': "multiple", 'disabled': "disabled" }, { 'valueChange': "valueChange", 'change': "change" }, ["_buttonToggles"]>;
}
/** @docs-private */
...
export declare class MatButtonToggle extends _MatButtonToggleMixinBase implements OnInit, CanDisableRipple, OnDestroy {
     ...
     */
    _markForCheck(): void;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<MatButtonToggle, "mat-button-toggle", ["matButtonToggle"], { 'disableRipple': "disableRipple", 'appearance': "appearance", 'checked': "checked", 'disabled': "disabled", 'id': "id", 'name': "name", 'ariaLabel': "aria-label", 'ariaLabelledby': "aria-labelledby", 'value': "value", 'tabIndex': "tabIndex" }, { 'change': "change" }, never>;
}
export {};
