...
export declare class MatSort extends _MatSortMixinBase implements CanDisable, HasInitialized, OnChanges, OnDestroy, OnInit {
    ...
    ngOnChanges(): void;
    ngOnDestroy(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MatSort, "[matSort]", ["matSort"], { 'disabled': "matSortDisabled", 'direction': "matSortDirection", 'disableClear': "matSortDisableClear", 'active': "matSortActive", 'start': "matSortStart" }, { 'sortChange': "matSortChange" }, never>;
}
export {};
