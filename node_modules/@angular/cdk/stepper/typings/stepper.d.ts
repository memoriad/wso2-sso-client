...
export declare class CdkStep implements OnChanges {
    ...
    reset(): void;
    ngOnChanges(): void;
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<CdkStep, "cdk-step", ["cdkStep"], { 'editable': "editable", 'optional': "optional", 'completed': "completed", 'hasError': "hasError", 'stepControl': "stepControl", 'label': "label", 'errorMessage': "errorMessage", 'ariaLabel': "aria-label", 'ariaLabelledby': "aria-labelledby", 'state': "state" }, {}, ["stepLabel"]>;
}
export declare class CdkStepper implements AfterViewInit, OnDestroy {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<CdkStepper, "[cdkStepper]", ["cdkStepper"], { 'linear': "linear", 'selectedIndex': "selectedIndex", 'selected': "selected" }, { 'selectionChange': "selectionChange" }, ["_steps", "_stepHeader"]>;
}
/**
